...
if($Name !="" && $FatherName != "" && $Age != "" && $Gender != "" && $Weight != "" && $Blood_Type != "" && $KnownDisease != "" && $RegistrationDate != "" && $Address != "" && $City != "" && $Contact != "")
{

    $query = "INSERT INTO `donor`(`Name`, `FatherName`, `Age`, `Gender`, `Weight`, `Blood_Type`, `KnownDisease`, `RegistrationDate`, `Address`, `City`, `Contact`) VALUES ('$Name','$FatherName','$Age','$Gender','$Weight','$Blood_Type','$KnownDisease','$RegistrationDate','$Address','$City','$Contact')";
